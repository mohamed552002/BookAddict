...
namespace DataRepo.Ef.Services
{
    ...
    public class AuthService : IAuthService
    {
        ...
        public async Task<AuthModel> GetTokenasync(TokenRequestDto tokenRequestModel)
        {
            ...
            var authModel = new AuthModel(true,user.UserName,user.Email,userRoles.ToList(),new JwtSecurityTokenHandler().WriteToken(jwtSecurityToken),jwtSecurityToken.ValidTo);
